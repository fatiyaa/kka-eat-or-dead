...
class HowToPlay:
    ...
    # memproses/mengambil text dari howtoplay.txt ke screen
    def load_text_from_file(self):
        with open('howtoplay.txt', 'r') as file:
            self.text_content = file.read().splitlines()

    # menampilkan halaman how to play
    def draw(self):
        self.draw_text()
    ...
    def draw_text(self):
        ...
        for line in self.text_content:
            text_surface = font.render(line, True, (0, 0, 0)).convert_alpha()
    ...
    # menampilkan pilihan algoritma jika bermain dengan ai 
